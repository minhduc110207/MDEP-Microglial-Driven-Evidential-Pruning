...
EXPERIMENTS: dict[str, ExperimentSpec] = {
    ...
    "rigl_style_24_efl": ExperimentSpec(
        name="rigl_style_24_efl",
        family="dynamic_sparse_baseline",
        description="RigL-style 2:4 + EFL.",
        sparse=True,
        use_mdep_trainer=True,
        loss_name="edl",
        pruner_type="magnitude",
    ...
    "static_24_edl_efl": ExperimentSpec(
        name="static_24_edl_efl",
        family="dynamic_sparse_baseline",
        description="Static 2:4 sparse EDL + EFL.",
        sparse=True,
        static_sparse=True,
        loss_name="edl",
        kl_scaling="symmetric",
    ...
    "dense_edl_efl": ExperimentSpec(
        name="dense_edl_efl",
        family="evidential_baseline",
        description="Dense EDL + EFL.",
        loss_name="edl",
        kl_scaling="symmetric",
        disable_efl=False,
    ),
    "guds_random_regrower": ExperimentSpec(
        name="guds_random_regrower",
        family="ablation",
        description="GUDS-EDL with random regrowth.",
        sparse=True,
        use_mdep_trainer=True,
        loss_name="edl",
        pruner_type="signed_first_order",
        regrower_type="random",
        kl_scaling="symmetric",
    ),
    "guds_task_gradient_regrower": ExperimentSpec(
        name="guds_task_gradient_regrower",
        family="ablation",
        description="GUDS-EDL with task-gradient regrowth.",
        sparse=True,
        use_mdep_trainer=True,
        loss_name="edl",
        pruner_type="signed_first_order",
