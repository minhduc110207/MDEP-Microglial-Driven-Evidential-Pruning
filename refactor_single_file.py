...
Z.~Miao, Z.~Miao, X.~Zhan, J.~Wang, B.~Gong, and S.~X. Yu.
...
\end{itemize}"""
    ...
    # Assemble unified main_text.tex
    # Header -> Abstract -> Intro -> Related -> Method -> Fig1 -> Method2 -> Optimization -> Experimental Setup -> Results -> References -> Appendix -> End
    unified_tex = preamble + "\n\n" + abstract + "\n\n" + intro + "\n\n" + related_work + "\n\n" + method + "\n\n" + fig1 + "\n\n" + method_2 + "\n\n" + optimization + "\n\n" + experimental_setup + "\n\n" + results + "\n\n" + references + "\n\n" + appendix_str + "\n\n\\end{document}"
